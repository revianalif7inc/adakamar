...
class MiddlewareNameResolver
{
    ...
    public static function resolve($name, $map, $middlewareGroups)
    {
        ...
        // Debug: log when resolving middleware names in testing/local env
        if (app()->environment('local', 'testing')) {
            \Illuminate\Support\Facades\Log::info('MiddlewareNameResolver resolving', ['name' => $name, 'map' => array_keys($map)]);
        }
