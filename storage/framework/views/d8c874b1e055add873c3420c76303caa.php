        ...
        <div class="container">
            <div class="admin-header">
                <div>
                    ...
                    <p class="text-muted">Perbarui informasi kategori <?php echo e($category->name); ?></p>
                </div>
            </div>
            ...
            <div class="admin-section">
                <div class="section-body">
                    ...
                    <form action="<?php echo e(route('admin.categories.update', $category)); ?>" method="POST" class="admin-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control"
                                value="<?php echo e(old('name', $category->name)); ?>" placeholder="Masukkan nama kategori" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control" rows="4"
                                placeholder="Jelaskan kategori ini..."><?php echo e(old('description', $category->description)); ?></textarea>
                            <small class="form-text">Deskripsi singkat tentang kategori (opsional)</small>
                        </div>

                        <div class="form-group">
                            <label><input type="checkbox" name="is_pinned" value="1" <?php echo e(old('is_pinned', $category->is_pinned) ? 'checked' : ''); ?>> Pin kategori (tampilkan lebih dahulu)</label>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\adakamar\resources\views/admin/categories/edit.blade.php ENDPATH**/ ?>