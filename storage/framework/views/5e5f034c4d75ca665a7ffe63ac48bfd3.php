        ...
        <div class="container">
            ...
            <div class="admin-section">
                <div class="section-body">
                    ...
                    <form action="<?php echo e(route('admin.locations.store')); ?>" method="POST" class="admin-form">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control" rows="4"
                                placeholder="Jelaskan lokasi ini..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\adakamar\resources\views/admin/locations/create.blade.php ENDPATH**/ ?>