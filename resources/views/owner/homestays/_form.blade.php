...
<div class="form-row">
    <div class="form-group">
        ...
        <select id="categories" name="categories[]" class="form-control" multiple required>
            @php $selected = old('categories', isset($homestay) ? ($homestay->categories->pluck('id')->toArray() ?? []) : []); @endphp
...
<div class="form-row">
    <div class="form-group">
        ...
        <input type="number" id="max_guests" name="max_guests" class="form-control" value="{{ old('max_guests', $homestay->max_guests ?? 1) }}" min="1" required>
    </div>
</div>
...
<div class="form-row">
    <div class="form-group">
        ...
        <input type="number" name="bedrooms" id="bedrooms"
            class="form-control @error('bedrooms') is-invalid @enderror" min="1"
            value="{{ old('bedrooms', $homestay->bedrooms ?? 1) }}" required>
