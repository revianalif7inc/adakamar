        ...
        <nav class="navbar navbar-expand-lg navbar-dark container">
            ...
            <div class="collapse navbar-collapse" id="mainNav">
                <ul class="navbar-nav align-items-lg-center main-menu me-auto text-uppercase fw-semibold">
                    ...
                    <li class="nav-item"><a class="nav-link {{ request()->routeIs('kamar.*') ? 'active' : '' }}" href="{{ route('kamar.index') }}">Explore Kost!</a>
                    </li>
                    <li class="nav-item"><a class="nav-link {{ (request()->routeIs('artikel.*') || request()->is('artikel*')) ? 'active' : '' }}" href="{{ route('artikel.index') }}">Artikel</a></li>
                </ul>

                <div class="d-flex align-items-center">
                    <form action="{{ route('kamar.index') }}" method="GET" class="d-flex navbar-search-form d-none d-lg-flex ms-3"
                        role="search">
