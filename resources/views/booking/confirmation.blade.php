            ...
            <div class="confirmation-box confirmation-page">
                <div class="confirmation-hero">
                    ...
                    <div class="hero-text">
                        ...
                        <p class="muted">Terima kasih — pesanan Anda telah diterima. Nomor pesanan <strong>#{{ $booking->id }}</strong></p>
                    </div>
                ...
                <div class="confirmation-grid">
                    ...
                    <div class="confirmation-card details">
                        ...
                        <ul class="booking-breakdown">
                            <li><span>Subtotal</span><span>Rp {{ number_format(max(0, $booking->total_price), 0, ',', '.') }}</span></li>
                            <li><span>Diskon</span><span>Rp 0</span></li>
                            <li class="total"><strong>Total</strong><strong>Rp {{ number_format(max(0, $booking->total_price), 0, ',', '.') }}</strong></li>
                        </ul>
                        ...
                        <div class="confirm-actions">
                            ...
                            @if(!empty($booking->homestay->owner->phone))
                                <a href="tel:{{ $booking->homestay->owner->phone }}" class="btn btn-secondary"><i class="fa fa-phone btn-icon" aria-hidden="true"></i> Hubungi Pemilik</a>
                            @endif

                            <a href="{{ url('bookings/' . $booking->id) }}" class="btn btn-outline"><i class="fa fa-file-alt btn-icon" aria-hidden="true"></i> Lihat Detail Pemesanan</a>
                        </div>
                ...
                <div class="action-buttons">
                    <a href="{{ route('home') }}" class="btn btn-ghost"><i class="fa fa-home btn-icon" aria-hidden="true"></i> Kembali ke Beranda</a>
                    <a href="{{ route('homestays.index') }}" class="btn btn-outline"><i class="fa fa-search btn-icon" aria-hidden="true"></i> Lihat Homestay Lainnya</a>
                </div>
            </div>
        </div>
    </div>
