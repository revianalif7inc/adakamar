                    ...
                    <form action="{{ route('admin.categories.store') }}" method="POST" class="admin-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="slug" name="slug" class="form-control @error('slug') is-invalid @enderror" 
                                value="{{ old('slug') }}" placeholder="URL-friendly slug, kosongkan untuk auto-generate">
                            <small class="form-text">Gunakan huruf kecil, angka, dan tanda hubung. Kosongkan untuk generate otomatis dari nama.</small>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror" 
                                rows="4" placeholder="Jelaskan kategori ini...">{{ old('description') }}</textarea>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="number" id="sort_order" name="sort_order" class="form-control @error('sort_order') is-invalid @enderror"
                                    value="{{ old('sort_order') }}" placeholder="0">
                                <small class="form-text">Angka lebih kecil tampil lebih awal (kosongkan untuk di akhir)</small>
                            ...
                            <div class="form-group">
                                <label for="is_pinned" class="form-check-label">
                                    ...
                                    <input type="checkbox" id="is_pinned" name="is_pinned" value="1" class="form-check-input" 
